---
title: "Why does Techstars think this ingredient is the most important one in startups?"
author: "Ran Du"
date: "21/02/2020"
output:
...
Read all the datasets about the startups.
```{r}
library(dplyr)
...
ggplot(companies, aes(x = as.factor(Founded.Year), y = Total.Funding.Amount.Currency..in.USD.)) + 
    ...
    ggtitle("Great Seattle Area Startups 2010-2019") +
...
#Aggregate number of founders to 1,2,3, and 4+
companies$Categroy.Number.of.Founders <- as.factor(ifelse(companies$Number.of.Founders == 1, "Solo", ifelse(companies$Number.of.Founders == 2, "Double Up", ifelse(companies$Number.of.Founders == 3, "Three Musketeers", "Fantastic Four and more"))))
companies$Categroy.Number.of.Founders <- factor(companies$Categroy.Number.of.Founders, c("Solo","Double Up", "Three Musketeers","Fantastic Four and more"))
...
ggplot(companies, aes(x= Number.of.Founders, y = log10(Total.Funding.Amount.Currency..in.USD.))) +
  ...
  ggtitle("Great Seattle Area Startups 2010-2019 (companies with no funding removed)") +
...
Read all the datasets about the founders
```{r}
